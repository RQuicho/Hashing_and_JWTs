...
class User {
  ...
  static async authenticate(username, password) {
    ...
    return user && await bcrypt.compare(password, user.password); //bcrypt.compare returns boolean
    ...
    // if (results.rows[0].username !== typedUsername || results.rows[0].password !== typedPassword) {
    //   return false;
    // } else {
    //   return true;
    // }
